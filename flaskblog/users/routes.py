...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Your account have been created!', category='success')
...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your account have being updated', category='success')
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Your password have been updated', category='success')
        return redirect(url_for('users.login'))
